    ...
    <>
      ...
      <div className=" flex flex-col min-h-screen w-full item text-xl leading-tight">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:gap-14 gap-10 py-14">
              ...
              >
                ...
                >
                  <source
                    src="/assets/videos/salesforce.mp4"
                    type="video/mp4"
                  />
              ...
              >
                <video
                  ...
                  className="rounded-md w-[400px] md:h-[300px] h-[200px] object-cover"
                >
                  <source src="/assets/videos/turo.mp4" type="video/mp4" />
                  Your browser does not support the video tag.
                </video>
                <div>
              ...
              >
                <video
                  ...
                  className="rounded-md w-[400px] md:h-[300px] h-[200px] object-cover"
                >
                  <source src="/assets/videos/tile.mp4" type="video/mp4" />
                  Your browser does not support the video tag.
                </video>
                <div>
        ...
        <section className="py-20 max-w-7xl mx-auto">
          ...
          <p className="py-8 text-center max-w-5xl md:px-10 px-2 text-lg mx-auto">
            From competitive analysis to interactive prototypes, our agency
            implements engaging and simple-to-use user interfaces. Our
            user-friendly product design helps companies achieve quantifiable
            business goals through output that captivates the customer and sets
