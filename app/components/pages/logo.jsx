...
const logosData = [
  ...
  //   description:
  //     "Collaborative work for digital asset management tools at Adobe",
  // },
  // {
  //   logo: "https://www.datocms-assets.com/22695/1715859200-crunchbase.svg",
  //   description:
  //     "Website redesign and user interface improvements for Crunchbase",
  // },
  // {
  ...
  //   description:
  //     "Illustrations and UI components for Redis Labs developer resources",
  // },
  // {
  //   logo: "https://www.datocms-assets.com/22695/1715843747-okta-c.svg",
  //   description:
  //     "Design and identity branding for security software company Okta",
  // },
  // {
  //   logo: "https://www.datocms-assets.com/22695/1715859240-cellebrite-c.svg",
  //   description:
  //     "Corporate website design for data analysis software provider Cellebrite",
  // },
  // {
  ...
  //   description:
  //     "Product design and marketing material for data onboarding platform Flatfile",
  // },
  // {
  ...
  //   description:
  //     "UI design and brand identity for machine learning tool Streamlit",
  // },
  // {
  ...
  //   description:
  //     "User interface and dashboard designs for Xero's financial tools",
  // },
  // {
...
const Logo = () => {
  return (
    <div className="flex-wrap justify-center grid md:grid-cols-5 grid-cols-3">
      {logosData.map(
        (item, index) =>
          index <= 14 && (
