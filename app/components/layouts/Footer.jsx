...
const Footer = () => {
  return (
    <footer className="bg-[#0f1115] text-white p-8 w-full">
      ...
      <div className='flex flex-col items-center text-center w-full max-w-[800px] mx-auto px-4 mt-16'>
        ...
        <h2 className="text-[30px] md:text-[52px] mt-8 leading-none">
          See how Brainhub clients are changing the future of tech.
        </h2>
      ...
      <div className="container grid grid-cols-1 md:grid-cols-6 gap-8 mt-16">
        ...
        <div className="md:col-span-1">
          ...
          <ul className="mt-2 space-y-1">
            <a href="#service1" className="block text-gray-300 hover:bg-gray-600 py-2">Web development</a>
            <a href="#service2" className="block text-gray-300 hover:bg-gray-600 py-2">Mobile app development</a>
            <a href="#service3" className="block text-gray-300 hover:bg-gray-600 py-2">UI/UI Development</a>
            <a href="#service4" className="block text-gray-300 hover:bg-gray-600 py-2">Desktop app development</a>
            <a href="#service5" className="block text-gray-300 hover:bg-gray-600 py-2">Digital product development</a>
          </ul>
        </div>
        ...
        <div className="md:col-span-1">
          ...
          <ul className="mt-2 space-y-1">
            <a href="#team" className="block text-gray-300 hover:bg-gray-600 py-2">React js</a>
            <a href="#mission" className="block text-gray-300 hover:bg-gray-600 py-2">Node js</a>
            <a href="#vision" className="block text-gray-300 hover:bg-gray-600 py-2">React Native</a>
            <a href="#history" className="block text-gray-300 hover:bg-gray-600 py-2">Next js</a>
          </ul>
        </div>
        ...
        <div className="md:col-span-1">
          ...
          <ul className="mt-2 space-y-1">
            <a href="#team" className="block text-gray-300 hover:bg-gray-600 py-2">Banking</a>
            <a href="#mission" className="block text-gray-300 hover:bg-gray-600 py-2">Bloging</a>
            <a href="#vision" className="block text-gray-300 hover:bg-gray-600 py-2">Fintech</a>
            <a href="#history" className="block text-gray-300 hover:bg-gray-600 py-2">Insurance</a>
          </ul>
        </div>
      ...
      <div className="mt-8 border-t border-gray-700 pt-4">
        <div className="container flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} WebGrid. All rights reserved.</p>
          <div className="flex space-x-4 mt-2 md:mt-0">
            <a href="/privacy-policy" className="text-gray-300 hover:text-[#49ffe6] text-sm">Privacy Policy</a>
            <a href="/terms-and-conditions" className="text-gray-300 hover:text-[#49ffe6] text-sm">Terms & Conditions</a>
          </div>
          <div className="flex space-x-4 mt-2 md:mt-0">
            <a href="#" className="text-gray-300 hover:text-[#49ffe6]">
